...
public class AuladomainApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2021-03-12T12:34:12Z"), OrderStatus.PAID, c1);
		Order o2 = new Order(null, Instant.parse("2021-03-20T23:56:54Z"), OrderStatus.WAITING, c1);
